---
title: Access to CAARA Facilities
tags: policy
---
...
1. In order for a person to be granted access, either to the building or to other areas within the building, one or more of the following criteria must be met, in no particular order, the application of which shall be solely determined by the Board of Directors:
   - Any person requesting access MUST be a Member of The Association, and have been in Good Standing for at least the previous 6 months.
   - Upon request, Association Officers and Directors will be issued keys for the duration of their term.
   - Any Member requesting a code for key box and building access must state their need for access. Alternatively, the Member's request may be sponsored by an Officer or Board Member.
   ...
   - The Member must be checked out on radio equipment on the first floor station by a club officer before being allowed access to the first floor transmitter.
...
**Code access and key access policies:**

- The house committee chair will hold a Master List of Keyholders and Members with code access who have been approved by the board for first floor access.
- The House chair will provide a code to access the key box and instructions on security system activation / deactivation upon approval of the board.
- Should the board become aware of a loss of keys or compromised access to the key code, a recut of keys and key code change should take place.
- The code for building access will be rotated yearly after dues collection and normalization of the membership list.
- No person given access to the key code will divulge the combination to others.
- No person given such access shall remove the code box key from the premises for any reason.
- Second floor access will be granted to all board members and officers upon request.
- A board member or officer must be present in the building for the second floor to be opened up for use by the general membership during meetings or functions.
- Second floor access may be granted to a member by explicit vote of the board of directors.
- Violation of these or other club policies will result in loss of access privilege at the discretion of the board and officers.
- Members should note that the building is under 24/7 video surveillance.
- Please consult the CAARA website Events Calendar to determine if the clubhouse is already booked for other activities (regular scheduled meetings, VE sessions, events, etc.) or scheduled by other members before planning to use the clubhouse.
...
## Care and Use of CAARA Facilities
